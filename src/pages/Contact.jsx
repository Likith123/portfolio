...
function Contact() {
  return (
    <section className="w-full h-screen bg-[#f4f5ff]">
      {/* Contact Form */}
      <h1 className="pt-8 text-3xl font-semibold text-center">
        Contact <span className="text-[#0693f0]">Me</span>
      </h1>

      <div className="w-[100%] h-[80%] flex flex-1 justify-center items-center gap-16 pt-12 px-16">
        <div className="w-[50%] h-[100%] flex justify-center items-center">
          ...
          >
            ...
            <button className="bg-slate-500 rounded-sm w-40 h-12">Get In Touch</button>
          </form>
        </div>
